...
echo "Auto STEP"
echo "STEP 1: use boot_v1.2+ by default"
echo "STEP 2: choose bin generate(1=user1.bin)"
echo "STEP 3: choose spi speed(40MHz)"
echo "STEP 4: choose spi mode(0=QIO)"
echo "STEP 5: choose spi size and map:1024KB( 512KB+ 512KB)"
echo ""
